...
```{r}
select(pups_df, litter_number, sex)
```
...
read_csv("FAS_litters.csv", na = c("NA", ".", "")) |>
  ...
  lm(wt_gain ~ pups_born_alive = _) #Underscore does?
```
...
write_csv(litters_df, "data/cleaned_fas_littered.csv")
```
